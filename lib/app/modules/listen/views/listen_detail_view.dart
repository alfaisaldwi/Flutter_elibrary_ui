                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        IconButton(
                          onPressed: () {},
                          icon: Icon(PhosphorIcons.fill.speakerLow,
                              color: Color(0xffFF735C)),
                        ),
                        Padding(
                        ...
                        Row(
                          children: [
                            IconButton(
                              onPressed: () {},
                              icon:
                                  Icon(Icons.shuffle, color: Color(0xffFF735C)),
                            ),
                            IconButton(
                              onPressed: () {},
                              icon:
                                  Icon(Icons.repeat, color: Color(0xffFF735C)),
                            ),
                          ],
                        ),
                      ],
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          '00:00',
                          style: GoogleFonts.roboto(color: Color(0xffFF735C)),
                        ),
                        Text(
                          '04:00',
                          style: GoogleFonts.roboto(color: Color(0xffFF735C)),
